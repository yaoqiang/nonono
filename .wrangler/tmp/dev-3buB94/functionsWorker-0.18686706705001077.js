...
// .wrangler/tmp/bundle-HfBFgW/checked-fetch.js
...
// .wrangler/tmp/bundle-HfBFgW/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-vWZA5n/functionsWorker-0.18686706705001077.mjs
...
var onRequestPost = /* @__PURE__ */ __name2(async (context) => {
  ...
  const gender = ["male", "female", "other"].includes(body.gender || "") ? body.gender : void 0;
  const cf = request.cf || {};
  const country = typeof cf.country === "string" ? cf.country : void 0;
  const city = typeof cf.city === "string" ? cf.city : void 0;
...
// .wrangler/tmp/bundle-HfBFgW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HfBFgW/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.18686706705001077.js.map
